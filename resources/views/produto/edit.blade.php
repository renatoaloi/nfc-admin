...
@section('title', 'Edit Produto')

@section('breadcrumbs')
{!! Breadcrumbs::render('produto.edit', $produto->id) !!}
@endsection
  ...
  <div class="col-md-6">
    ...
    <div class="panel panel-flat">
      <div class="panel-heading">
        <h5 class="panel-title">Edit Produto #{{ $produto->id }}</h5>
      ...
      <div class="panel-body">
        <form class="form-horizontal" role="form" method="POST" action="{{ route('produto.update', ['id' => $produto->id]) }}">
          {{ csrf_field() }}
          <div class="form-group{{ $errors->has('nome') ? ' has-error' : '' }}">
              <label for="nome" class="col-md-4 control-label">Nome</label>
              <div class="col-md-6">
                  <input id="nome" type="text" class="form-control" 
                         name="nome" value="{{ $produto->nome }}" required autofocus>
                  @if ($errors->has('nome'))
          ...
          <div class="form-group{{ $errors->has('disponivel') ? ' has-error' : '' }}">
              ...
              <div class="col-md-6">
                  <input id="disponivel" type="checkbox" class="form-control" 
                         name="disponivel" {{ $produto->disponivel ? 'checked' : '' }} >
